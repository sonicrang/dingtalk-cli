...
export class KickoffByDeviceIdHeaders extends $tea.Model {
  commonHeaders?: { [key: string]: string };
  xAcsDingtalkAccessToken?: string;
  static names(): { [key: string]: string } {
    return {
...
export class KickoffByDeviceIdRequest extends $tea.Model {
  openDeviceId?: string;
  userId?: string;
  static names(): { [key: string]: string } {
    return {
...
export class KickoffByDeviceIdResponseBody extends $tea.Model {
  errorCode?: string;
  errorMsg?: string;
  success?: boolean;
  static names(): { [key: string]: string } {
...
export class KickoffByDeviceIdResponse extends $tea.Model {
  headers?: { [key: string]: string };
  statusCode?: number;
  body?: KickoffByDeviceIdResponseBody;
  static names(): { [key: string]: string } {
    return {
      headers: 'headers',
      statusCode: 'statusCode',
...
export default class Client extends OpenApi {
   ...
   * @param runtime - runtime options for this request RuntimeOptions
   * @returns KickoffByDeviceIdResponse
   */
  async kickoffByDeviceIdWithOptions(request: KickoffByDeviceIdRequest, headers: KickoffByDeviceIdHeaders, runtime: $Util.RuntimeOptions): Promise<KickoffByDeviceIdResponse> {
    Util.validateModel(request);
    let body : {[key: string ]: any} = { };
    if (!Util.isUnset(request.openDeviceId)) {
    ...
    return $tea.cast<KickoffByDeviceIdResponse>(await this.execute(params, req, runtime), new KickoffByDeviceIdResponse({}));
  }
   ...
   * @returns KickoffByDeviceIdResponse
   */
  async kickoffByDeviceId(request: KickoffByDeviceIdRequest): Promise<KickoffByDeviceIdResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    let headers = new KickoffByDeviceIdHeaders({ });
    return await this.kickoffByDeviceIdWithOptions(request, headers, runtime);
  }
