...
export class AddWorkspacesManagerHeaders extends $tea.Model {
  commonHeaders?: { [key: string]: string };
  xAcsDingtalkAccessToken?: string;
  static names(): { [key: string]: string } {
    return {
...
export class AddWorkspacesManagerRequest extends $tea.Model {
  /**
   * @remarks
   * This parameter is required.
   * 
...
export class AddWorkspacesManagerResponseBody extends $tea.Model {
  /**
   * @example
   * true
   */
...
export class AddWorkspacesManagerResponse extends $tea.Model {
  headers?: { [key: string]: string };
  statusCode?: number;
  body?: AddWorkspacesManagerResponseBody;
  static names(): { [key: string]: string } {
    return {
      headers: 'headers',
      statusCode: 'statusCode',
...
export class ListOrgWorkspacesHeaders extends $tea.Model {
  commonHeaders?: { [key: string]: string };
  xAcsDingtalkAccessToken?: string;
  static names(): { [key: string]: string } {
    return {
...
export class ListOrgWorkspacesRequest extends $tea.Model {
  /**
   * @remarks
   * This parameter is required.
   * 
...
export class ListOrgWorkspacesResponseBody extends $tea.Model {
  pageNumber?: number;
  pageSize?: number;
  workspaces?: ListOrgWorkspacesResponseBodyWorkspaces[];
  static names(): { [key: string]: string } {
    return {
      pageNumber: 'pageNumber',
      pageSize: 'pageSize',
  ...
  static types(): { [key: string]: any } {
    return {
      pageNumber: 'number',
      pageSize: 'number',
      workspaces: { 'type': 'array', 'itemType': ListOrgWorkspacesResponseBodyWorkspaces },
    };
  }
...
export class ListOrgWorkspacesResponse extends $tea.Model {
  headers?: { [key: string]: string };
  statusCode?: number;
  body?: ListOrgWorkspacesResponseBody;
  static names(): { [key: string]: string } {
    return {
      headers: 'headers',
      statusCode: 'statusCode',
...
export class ListOrgWorkspacesResponseBodyWorkspaces extends $tea.Model {
  /**
   * @example
   * 0
   */
...
export default class Client extends OpenApi {
   ...
   * @param runtime - runtime options for this request RuntimeOptions
   * @returns AddWorkspacesManagerResponse
   */
  async addWorkspacesManagerWithOptions(request: AddWorkspacesManagerRequest, headers: AddWorkspacesManagerHeaders, runtime: $Util.RuntimeOptions): Promise<AddWorkspacesManagerResponse> {
    Util.validateModel(request);
    let query : {[key: string ]: any} = { };
    if (!Util.isUnset(request.operatorId)) {
      query["operatorId"] = request.operatorId;
    ...
    return $tea.cast<AddWorkspacesManagerResponse>(await this.execute(params, req, runtime), new AddWorkspacesManagerResponse({}));
  }
   ...
   * @returns AddWorkspacesManagerResponse
   */
  async addWorkspacesManager(request: AddWorkspacesManagerRequest): Promise<AddWorkspacesManagerResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    let headers = new AddWorkspacesManagerHeaders({ });
    return await this.addWorkspacesManagerWithOptions(request, headers, runtime);
  }
   ...
   * @param runtime - runtime options for this request RuntimeOptions
   * @returns ListOrgWorkspacesResponse
   */
  async listOrgWorkspacesWithOptions(request: ListOrgWorkspacesRequest, headers: ListOrgWorkspacesHeaders, runtime: $Util.RuntimeOptions): Promise<ListOrgWorkspacesResponse> {
    Util.validateModel(request);
    let query : {[key: string ]: any} = { };
    if (!Util.isUnset(request.operatorId)) {
      query["operatorId"] = request.operatorId;
    ...
    return $tea.cast<ListOrgWorkspacesResponse>(await this.execute(params, req, runtime), new ListOrgWorkspacesResponse({}));
  }
   ...
   * @returns ListOrgWorkspacesResponse
   */
  async listOrgWorkspaces(request: ListOrgWorkspacesRequest): Promise<ListOrgWorkspacesResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    let headers = new ListOrgWorkspacesHeaders({ });
    return await this.listOrgWorkspacesWithOptions(request, headers, runtime);
  }
