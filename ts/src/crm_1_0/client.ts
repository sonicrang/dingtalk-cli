...
export class SetUserVersionToFreeHeaders extends $tea.Model {
  commonHeaders?: { [key: string]: string };
  xAcsDingtalkAccessToken?: string;
  static names(): { [key: string]: string } {
    return {
...
export class SetUserVersionToFreeRequest extends $tea.Model {
  /**
   * @example
...
export class SetUserVersionToFreeResponseBody extends $tea.Model {
  result?: boolean;
  static names(): { [key: string]: string } {
    return {
      result: 'result',
...
export class SetUserVersionToFreeResponse extends $tea.Model {
  headers?: { [key: string]: string };
  statusCode?: number;
  body?: SetUserVersionToFreeResponseBody;
  static names(): { [key: string]: string } {
    return {
      headers: 'headers',
      statusCode: 'statusCode',
...
export default class Client extends OpenApi {
   ...
   * @param runtime - runtime options for this request RuntimeOptions
   * @returns SetUserVersionToFreeResponse
   */
  async setUserVersionToFreeWithOptions(request: SetUserVersionToFreeRequest, headers: SetUserVersionToFreeHeaders, runtime: $Util.RuntimeOptions): Promise<SetUserVersionToFreeResponse> {
    Util.validateModel(request);
    let body : {[key: string ]: any} = { };
    if (!Util.isUnset(request.operatorUserId)) {
      body["operatorUserId"] = request.operatorUserId;
    ...
    return $tea.cast<SetUserVersionToFreeResponse>(await this.execute(params, req, runtime), new SetUserVersionToFreeResponse({}));
  }
   ...
   * @returns SetUserVersionToFreeResponse
   */
  async setUserVersionToFree(request: SetUserVersionToFreeRequest): Promise<SetUserVersionToFreeResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    let headers = new SetUserVersionToFreeHeaders({ });
    return await this.setUserVersionToFreeWithOptions(request, headers, runtime);
  }
