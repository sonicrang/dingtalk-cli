...
export class QueryInstalledCoolAppsInConversationHeaders extends $tea.Model {
  commonHeaders?: { [key: string]: string };
  xAcsDingtalkAccessToken?: string;
  static names(): { [key: string]: string } {
    return {
...
export class QueryInstalledCoolAppsInConversationRequest extends $tea.Model {
  /**
   * @example
   * cidxxx
   */
...
export class QueryInstalledCoolAppsInConversationResponseBody extends $tea.Model {
  result?: QueryInstalledCoolAppsInConversationResponseBodyResult;
  static names(): { [key: string]: string } {
    return {
      result: 'result',
    };
...
export class QueryInstalledCoolAppsInConversationResponse extends $tea.Model {
  headers?: { [key: string]: string };
  statusCode?: number;
  body?: QueryInstalledCoolAppsInConversationResponseBody;
  static names(): { [key: string]: string } {
    return {
      headers: 'headers',
      statusCode: 'statusCode',
...
export class QueryInstalledCoolAppsInConversationResponseBodyResultCoolApps extends $tea.Model {
  coolAppCode?: string;
  coolAppName?: string;
  static names(): { [key: string]: string } {
    return {
...
export class QueryInstalledCoolAppsInConversationResponseBodyResult extends $tea.Model {
  coolApps?: QueryInstalledCoolAppsInConversationResponseBodyResultCoolApps[];
  static names(): { [key: string]: string } {
    return {
      coolApps: 'coolApps',
    };
  ...
  static types(): { [key: string]: any } {
    return {
      coolApps: { 'type': 'array', 'itemType': QueryInstalledCoolAppsInConversationResponseBodyResultCoolApps },
    };
  }
...
export default class Client extends OpenApi {
   ...
   * @param runtime - runtime options for this request RuntimeOptions
   * @returns QueryInstalledCoolAppsInConversationResponse
   */
  async queryInstalledCoolAppsInConversationWithOptions(request: QueryInstalledCoolAppsInConversationRequest, headers: QueryInstalledCoolAppsInConversationHeaders, runtime: $Util.RuntimeOptions): Promise<QueryInstalledCoolAppsInConversationResponse> {
    Util.validateModel(request);
    let body : {[key: string ]: any} = { };
    ...
    return $tea.cast<QueryInstalledCoolAppsInConversationResponse>(await this.execute(params, req, runtime), new QueryInstalledCoolAppsInConversationResponse({}));
  }
   ...
   * @returns QueryInstalledCoolAppsInConversationResponse
   */
  async queryInstalledCoolAppsInConversation(request: QueryInstalledCoolAppsInConversationRequest): Promise<QueryInstalledCoolAppsInConversationResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    let headers = new QueryInstalledCoolAppsInConversationHeaders({ });
    return await this.queryInstalledCoolAppsInConversationWithOptions(request, headers, runtime);
  }
